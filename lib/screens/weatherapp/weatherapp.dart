                        ...
                        ? Column(
                            children: [
                              Container(
                                  height: 200,
                                  width: 200,
                                  child: responseRes['weather'][0]['main'] ==
                                          'Clouds'
                              ...
                              Text(responseRes['weather'][0]['main'],
                                  style: const TextStyle(
                                    fontSize: 35,
                                    fontWeight: FontWeight.bold,
                                  )),
                              Text(responseRes['weather'][0]['description'],
                                  style: const TextStyle(
                                    fontSize: 25,
                              ...
                              Container(
                                ...
                                margin:
                                    const EdgeInsets.only(top: 60, bottom: 60),
                                // height:300,
                                child: Row(
                                  mainAxisAlignment:
